package edu.cs4730.dialogdemo233;
...
/*
 * This example is intended to be used on V2.3.3 and below (API 10)
 *  * This is an example of how to use different dialogs
 *   A note, as of API 13 showDialog is a deprecated in favor of dialogFragments and support Dialogs
 *   this example is still valid on anything before 13.   Otherwise, YES   this is deprecated!
 */
